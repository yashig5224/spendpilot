...
// TypeScript in this project doesn't include a .d.ts for CSS imports.
// @ts-ignore
import "./globals.css";
...
export const metadata: Metadata = {
  metadataBase: new URL("https://spendpilot-one.vercel.app"),
  ...
  openGraph: {
    title: "SpendPilot — Audit Your AI Software Spend",
    description:
      "Stop overpaying for AI tools. Find hidden savings in minutes.",
    type: "website",
    images: [
      {
        url: "/og.png",
